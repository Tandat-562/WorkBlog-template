...
![SNS Topic](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/sns-topic.png)
...
![Confirm subscription](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/confirm-subscription.png)
...
![Test](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/test.png)
...
![Architecture-review-workflow](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/Architecture-review-workflow.png)
...
```
![Errors-Alarm](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/Errors-Alarm.png)
...
![Log Metric Filter](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/Log-Metric-Filter.png)
...
![AIArchitectureReviewer-APIGateway](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/AIArchitectureReviewer-APIGateway.png)
...
![AIArchitectureReviews-DynamoDB](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/AIArchitectureReviews-DynamoDB.png)
...
![AIArchitectureReviewer-EventBridge-FailedInvocations-Alarm](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/AIArchitectureReviewer-EventBridge-FailedInvocations-Alarm.png)
...
![Lambda-Upload-Service](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/Lambda-Upload-Service.png)
![Lambda-Upload-Service-Policy](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/Lambda-Upload-Service-Policy.png)

**Lambda AI Analyzer** cần quyền:

![Lambda-AI-Analyzer](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/Lambda-AI-Analyzer.png)
![Lambda-AI-Analyzer-Policy](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/Lambda-AI-Analyzer-Policy.png)

**Lambda Cost Tool** cần quyền:

![Lambda-Cost-Tool](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/Lambda-Cost-Tool.png)
![Lambda-Cost-Tool-Policy](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/Lambda-Cost-Tool-Policy.png)

**Lambda PDF Generator** cần quyền:

![Lambda-PDF-Generator](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/Lambda-PDF-Generator.png)
![Lambda-PDF-Generator-Policy](/WorkBlog-template/images/5-Workshop/5.7-Monitoring-security/Lambda-PDF-Generator-Policy.png)
