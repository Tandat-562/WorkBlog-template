...
![SNS Topic](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/sns-topic.png)
...
![Confirm subscription](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/confirm-subscription.png)
...
![Test](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/test.png)
...
![Architecture-review-workflow](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/Architecture-review-workflow.png)
...
```
![Errors-Alarm](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/Errors-Alarm.png)
...
![Log Metric Filter](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/Log-Metric-Filter.png)
...
![AIArchitectureReviewer-APIGateway](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/AIArchitectureReviewer-APIGateway.png)
...
![AIArchitectureReviews-DynamoDB](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/AIArchitectureReviews-DynamoDB.png)
...
![AIArchitectureReviewer-EventBridge-FailedInvocations-Alarm](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/AIArchitectureReviewer-EventBridge-FailedInvocations-Alarm.png)
...
![Lambda-Upload-Service](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/Lambda-Upload-Service.png)
![Lambda-Upload-Service-Policy](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/Lambda-Upload-Service-Policy.png)

**Lambda AI Analyzer** cần quyền:

![Lambda-AI-Analyzer](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/Lambda-AI-Analyzer.png)
![Lambda-AI-Analyzer-Policy](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/Lambda-AI-Analyzer-Policy.png)

**Lambda Cost Tool** cần quyền:

![Lambda-Cost-Tool](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/Lambda-Cost-Tool.png)
![Lambda-Cost-Tool-Policy](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/Lambda-Cost-Tool-Policy.png)

**Lambda PDF Generator** cần quyền:

![Lambda-PDF-Generator](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/Lambda-PDF-Generator.png)
![Lambda-PDF-Generator-Policy](//fcaj-workshop-template/images/5-Workshop/5.7-Monitoring-security/Lambda-PDF-Generator-Policy.png)
